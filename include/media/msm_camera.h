...
#define MSM_CAM_IOCTL_GET_SENSOR_OTP \
	_IOR(MSM_CAM_IOCTL_MAGIC, 68, struct msm_camsensor_info *)

#define MSM_CAM_IOCTL_FLASH_MODE_CTRL \
	_IOR(MSM_CAM_IOCTL_MAGIC, 69, struct msm_camsensor_info *)
...
//JZQ ADD 
#define CFG_OTP_PARAMS           55

//wt for yuv sensor
#define CFG_SET_AF              56
#define CFG_GET_ISO_INFO		57
#define CFG_FOR_MSLEEP          58
#define CFG_MAX                       59
