...
#if defined(CONFIG_TOUCHSCREEN_MXT224)||defined (CONFIG_TOUCHSCREEN_MXT336)
...
//
#if defined (CONFIG_MACH_NANIVAK)|| defined (CONFIG_MACH_ROUNDTOP)	// P896T10 P896A11
#define FTC_FW_NAME "Ver0B_20121114_U985_ID0x89_app.bin"
#define SYN_FW_NAME "U985-0x22A11LD-PR1183396-s2202_32313034_ESD.img"
#define ATM_FW_NAME ""
#elif defined (CONFIG_MACH_QUANTUM)
#define FTC_FW_NAME ""
#define SYN_FW_NAME "ZTE_P188F04_PR1350177_S3203_DS4_R3.2.1_35313049.img"
#define ATM_FW_NAME ""
...
#if defined CONFIG_MACH_QUANTUM	|| defined CONFIG_MACH_MAZAMA	// N9810, P896D01
#define SYNAPTICS_MAX_Y_POSITION	84//1949
static ssize_t cap_ts_vkeys_show(struct device *dev,	struct device_attribute *attr, char *buf)
{
	return sprintf(
		buf,__stringify(EV_KEY) ":" __stringify(KEY_BACK) ":120:1340:100:60"
		":" __stringify(EV_KEY) ":" __stringify(KEY_HOME) ":360:1340:100:60"
		":" __stringify(EV_KEY) ":" __stringify(KEY_MENU) ":600:1340:100:60"
		"\n");
}
// board elden
#elif defined (CONFIG_MACH_ELDEN)	//896M10
#define SYNAPTICS_MAX_Y_POSITION	69
static ssize_t cap_ts_vkeys_show(struct device *dev,	struct device_attribute *attr, char *buf)
{
	return sprintf(
...
#elif defined CONFIG_MACH_PRINDLE	// P896F10
#define SYNAPTICS_MAX_Y_POSITION	73//1268
static ssize_t cap_ts_vkeys_show(struct device *dev,	struct device_attribute *attr, char *buf)
{
	return sprintf(
		buf,__stringify(EV_KEY) ":" __stringify(KEY_BACK) ":120:1335:100:50"
		":" __stringify(EV_KEY) ":" __stringify(KEY_HOME) ":360:1335:100:50"
		":" __stringify(EV_KEY) ":" __stringify(KEY_MENU) ":600:1335:100:50"
		"\n");
}
