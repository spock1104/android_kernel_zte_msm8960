...
#if defined(CONFIG_MACH_JARVIS)||defined(CONFIG_MACH_PRINDLE)
...
/* ZTE_Audio_CJ_120530, chenjun, 2012-05-30, start */
#if defined(CONFIG_MACH_ELDEN) ||defined(CONFIG_MACH_GORDON) ||defined(CONFIG_MACH_HAYES)||defined(CONFIG_MACH_PRINDLE)
