...
static int mipi_novatek_lcd_on(struct platform_device *pdev)
{
	...
	switch(LcdPanleID){
			...
			case LCD_PANEL_4P3_OTM1281_OT_CMI:
				printk("CMI OTM1281A panel initialized!\n");
				cmdreq.cmds = OTM1281_CMI_CMD_INIT_PARA;
				cmdreq.cmds_cnt = ARRAY_SIZE(OTM1281_CMI_CMD_INIT_PARA);
				break;
			case LCD_PANEL_4P3_NT35590_TIANMA:
				...
				break;
			default:
				printk("OU!OU! NO PANEL...use TRULY OTM1281A AUO panel initialized!\n");
				cmdreq.cmds = OTM1281_AUO_CMD_INIT_PARA;
				cmdreq.cmds_cnt = ARRAY_SIZE(OTM1281_AUO_CMD_INIT_PARA);
				break;
