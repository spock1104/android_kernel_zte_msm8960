...
//yichangming
#define MHL_GPIO_INT            7
#define MHL_GPIO_RESET          8
//
...
/*
 * Support for FTM & RECOVERY mode by ZTE_BOOT_JIA_20121009, jia.jia
 * ZTE_PLATFORM
 */
...
/*
 * Support for reading board ID by ZTE_BOOT_JIA_20121023, jia.jia
 */
#ifdef CONFIG_ZTE_BOARD_ID
#if defined (CONFIG_MACH_QUANTUM)
typedef enum {
    HW_VER_01      = 0, /* GPIO13:0 GPIO42:0 GPIO43:0 */
    HW_VER_02      = 1, /* GPIO13:0 GPIO42:0 GPIO43:1 */
    HW_VER_03      = 2, /* GPIO13:0 GPIO42:1 GPIO43:0 */
    HW_VER_04      = 3, /* GPIO13:0 GPIO42:1 GPIO43:1 */
    HW_VER_INVALID = 4,
    HW_VER_MAX
} zte_hw_ver_type;
...
#elif defined (CONFIG_MACH_PRINDLE)
typedef enum {
    HW_VER_01      = 0, /* GPIO43:0 GPIO42:0 GPIO13:0 */
    HW_VER_02      = 1, /* GPIO43:0 GPIO42:0 GPIO13:1 */
    HW_VER_03      = 2, /* GPIO43:0 GPIO42:1 GPIO13:0 */
    HW_VER_04      = 3, /* GPIO43:0 GPIO42:1 GPIO13:1 */
    HW_VER_INVALID = 4,
    HW_VER_MAX
} zte_hw_ver_type;
...
const char* read_zte_hw_ver(void)
{
    ...
    if (!rc) {
        gpio_tlmm_config(GPIO_CFG(13, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA), GPIO_CFG_ENABLE);
    ...
    if (!rc) {
        gpio_tlmm_config(GPIO_CFG(42, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA), GPIO_CFG_ENABLE);
    ...
    if (!rc) {
        gpio_tlmm_config(GPIO_CFG(43, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA), GPIO_CFG_ENABLE);
    ...
    /*
      ...
      */
#if defined (CONFIG_MACH_QUANTUM)
    hw_ver = (zte_hw_ver_type)((val_gpio_13 << 2) | (val_gpio_42 << 1) | val_gpio_43);
#elif defined (CONFIG_MACH_PRINDLE) || defined (CONFIG_MACH_GORDON)
...
void __init msm8960_allocate_sdlog_region(void)
{
    ...
    pr_info("allocating 16m bytes at (0x87000000 physical) for sdlog\n");
...
static int zte_phy_init_seq_override[] = {
    ...
    0x39, 0x82,
    0x33, 0x83,
#elif defined(CONFIG_MACH_MAZAMA)
	0x44, 0x80,
	0x3f, 0x81,	
	0x3A, 0x82,
	0x13, 0x83,
#elif defined(CONFIG_MACH_ROUNDTOP)
	0x44, 0x80,
	0x3f, 0x81, 
	0x3A, 0x82,
	0x13, 0x83,
...
//yichangming
#if   (defined(CONFIG_FB_MSM_HDMI_MHL_8334) || defined(CONFIG_FB_MSM_HDMI_MHL_9244)) && !defined(CONFIG_MHL_Sii8334)
static struct msm_mhl_platform_data mhl_platform_data = {
	.irq = MSM_GPIO_TO_INT(7),//yichangming
...
#ifdef CONFIG_ISPCAM /* Modified By jzq for Flash 12.11.06*/
static void gsbi_qup_i2c_isp_gpio_config(int adap_id, int config_type)
{
...
/*
 * FTM device driver support by ZTE_BOOT_JIA_20121009 jia.jia
 * ZTE_PLATFORM
 */
...
#endif
#if   defined(CONFIG_FB_MSM_HDMI_MHL_8334) || defined(CONFIG_FB_MSM_HDMI_MHL_9244)
    &msm8960_device_qup_i2c_gsbi5,//yichangming
#endif
...
#if  defined(CONFIG_MACH_ROUNDTOP)
...
#if  defined(CONFIG_MACH_NUNIVAK) || defined (CONFIG_MACH_ROUNDTOP)
		 .orientation = {  1,  0,  0, 
				    0,  1,  0, 
				    0,  0, 1 },
#else
...
static struct i2c_board_info msm_i2c_gsbi12_sensors_info[] = {
	...
	{
		.type = "akm8962",
#if defined(CONFIG_MACH_QUANTUM)||defined(CONFIG_MACH_GORDON)||defined(CONFIG_MACH_HAYES)|| defined(CONFIG_MACH_ILIAMNA)||defined(CONFIG_MACH_ELDEN)
		.addr = 0x0E,
#else
		.addr = 0x0C,
#endif
...
static struct i2c_registry msm8960_i2c_devices[] __initdata = {
...

	{
		...
		MSM_8960_GSBI5_QUP_I2C_BUS_ID,//yichangming
		sii_device_info,
...
#ifdef CONFIG_ISPCAM //wt 2013-01-21
...
/*
 * Merged from msm8960 jb v17321J by ZTE_BOOT_JIA_20130201 jia.jia
 */
        ...
        mach_mask = I2C_FFA;
#elif defined (CONFIG_MACH_QUANTUM)
	else if (machine_is_quantum())
        mach_mask = I2C_FFA;
#elif defined (CONFIG_MACH_MAZAMA)
	else if (machine_is_mazama())
        mach_mask = I2C_FFA;
#elif defined (CONFIG_MACH_NUNIVAK)
	else if (machine_is_nunivak())
        mach_mask = I2C_FFA;
#elif defined (CONFIG_MACH_OKMOK)
	else if (machine_is_okmok())
        mach_mask = I2C_FFA;
#elif defined (CONFIG_MACH_PRINDLE)
	else if (machine_is_prindle())
        mach_mask = I2C_FFA;
#elif defined (CONFIG_MACH_ROUNDTOP)
	else if (machine_is_roundtop())
        mach_mask = I2C_FFA;
#endif
...
#if   (defined(CONFIG_FB_MSM_HDMI_MHL_8334) || defined(CONFIG_FB_MSM_HDMI_MHL_9244)) && !defined(CONFIG_MHL_Sii8334)
		printk("degug_ycm_1\n");
	if (msm8960_mhl_display_enabled()) {
		printk("degug_ycm_2\n");
...
{
/*
 * Support for reading board ID by ZTE_BOOT_JIA_20121009, jia.jia
 */
#ifdef CONFIG_ZTE_BOARD_ID
	...
	if (cpu_is_msm8960ab())
	{
		printk("socinfo: cpu is 8960ab\n");
		platform_device_register(&msm8960ab_device_acpuclk);
	}
	else
	{
		printk("socinfo: cpu is 8960\n");
...
/*
 * Added for Board Name by ZTE_BOOT_JIA_20130114 jia.jia
 */
#if defined(CONFIG_MACH_ELDEN)
...
MACHINE_END
#elif defined(CONFIG_MACH_QUANTUM)
MACHINE_START(QUANTUM, "ZTE MSM8960 QUANTUM")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,
...
MACHINE_END
#elif defined(CONFIG_MACH_MAZAMA)
MACHINE_START(MAZAMA, "ZTE MSM8960 MAZAMA")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,
...
MACHINE_END
#elif defined(CONFIG_MACH_NUNIVAK)
MACHINE_START(NUNIVAK, "ZTE MSM8960 NUNIVAK")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,
...
MACHINE_END
#elif defined(CONFIG_MACH_OKMOK)
MACHINE_START(OKMOK, "ZTE MSM8960 OKMOK")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,
...
MACHINE_END
#elif defined(CONFIG_MACH_PRINDLE)
MACHINE_START(PRINDLE, "ZTE MSM8960 PRINDLE")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,
...
MACHINE_END
#elif defined(CONFIG_MACH_ROUNDTOP)
MACHINE_START(ROUNDTOP, "ZTE MSM8960 ROUNDTOP")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,
