 ...
 *
 * $Id: dhd_linux.c 355620 2012-09-07 14:35:15Z $
 */
...
uint dhd_arp_mode = ARP_OL_AGENT | ARP_OL_HOST_AUTO_REPLY | ARP_OL_PEER_AUTO_REPLY;
...
static int dhd_suspend_resume_helper(struct dhd_info *dhd, int val, int force)
{
	...
	dhdp->in_suspend = val;
	if ((force || !dhdp->suspend_disable_flag) && (dhd_check_ap_wfd_mode_set(dhdp) == FALSE))
...
#endif	/* CUSTOMER_HW4 && PNO_SUPPORT */
...
#if defined(CUSTOMER_HW4) && defined(ROAM_ENABLE)
	uint roamvar = 0;
...
#endif /* CUSTOMER_HW4 && ROAM_ENABLE */
