...
static struct msm_camera_i2c_reg_conf mt9m114_720p_settings[] = {
	...
	{0xDC01, 0x52, MSM_CAMERA_I2C_BYTE_DATA, MSM_CAMERA_I2C_CMD_POLL},
       ...
       {0xC80E, 0x00DD,}, // CAM_SENSOR_CFG_FINE_INTEG_TIME_MIN
       {0xC810, 0x05B5,},  // CAM_SENSOR_CFG_FINE_INTEG_TIME_MAX
       {0xC812, 0x03ED,},  // CAM_SENSOR_CFG_FRAME_LENGTH_LINES
       {0xC814, 0x0639,},  // CAM_SENSOR_CFG_LINE_LENGTH_PCK
...
//1280*720 setting
	...
	{0xC834, 0x0000,},//0x0000/*sensor_control_read_mode = 0*/
...
static struct msm_camera_i2c_reg_conf mt9m114_recommend_settings1[] = {
	...
	{0xC818, 0x02D3,},/*cpipe_last_row = 723*/
	{0xC826, 0x0020,},/*reg_0_data = 32*/
	{0xC834, 0x0000,},//0x0000 1/*sensor_control_read_mode = 0*/
	{0xC854, 0x0000,},/*crop_window_xoffset = 0*/
	{0xC856, 0x0000,},/*crop_window_yoffset = 0*/
	{0xC858, 0x0500,},/*crop_window_width = 1280*/
	{0xC85A, 0x02D0,},/*crop_window_height = 720*/
...
//20130116 Adding the tuned AWB settings 
	...
	{0xC904, 0x004a}, // CAM_AWB_AWB_XSHIFT_PRE_ADJ
	{0xC906, 0x003c}, // CAM_AWB_AWB_YSHIFT_PRE_ADJ

//20130116 banding
	//{0xC000,0x03, MSM_CAMERA_I2C_BYTE_DATA}, //BANDING
	{0xC88B,0x32, MSM_CAMERA_I2C_BYTE_DATA}, //BANDING

// Saturation
	{0xC92A,0x80, MSM_CAMERA_I2C_BYTE_DATA}, //0x840xC0  //0x84
	{0xC92B,0x70, MSM_CAMERA_I2C_BYTE_DATA}, //0x460x60,0x46->0x82-120829  //0x82
	{0xC92D,0x60, MSM_CAMERA_I2C_BYTE_DATA}, //0xC0->0x60-120829
...
#if 1
static struct msm_camera_i2c_reg_conf mt9m114_config_change_settings1[] = {
};
#endif
...
static struct msm_camera_i2c_conf_array mt9m114_init_conf[] = {
	...
	ARRAY_SIZE(mt9m114_recommend_settings3), 10, MSM_CAMERA_I2C_WORD_DATA}, // 0ms
...
static struct msm_sensor_output_info_t mt9m114_dimensions[] = {
	{
	#if 0  //1280 * 720 setting
		.x_output = 0x500,
		.y_output = 0x2D0,
		.line_length_pclk = 0x640,
		.frame_length_lines = 0x3E8,
...
#if 0		
	.probe  = mt9m114_msm_sensor_i2c_probe,
#else
...
#if 0	
	.sensor_power_up = mt9m114_msm_sensor_power_up,
	.sensor_power_down = mt9m114_msm_sensor_power_down,
#else
...
static struct msm_sensor_reg_t mt9m114_regs = {
	...
	.start_stream_conf = mt9m114_config_change_settings1,
	.start_stream_conf_size = 0,//ARRAY_SIZE(mt9m114_config_change_settings1),
