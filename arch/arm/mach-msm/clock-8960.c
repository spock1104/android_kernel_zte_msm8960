...
//
	CLK_LOOKUP("core_clk",		gsbi6_qup_clk.c,	""),
	CLK_LOOKUP("core_clk",		gsbi7_qup_clk.c,	"qup_i2c.7"), /* Modified By jzq for Flash 12.11.06*/
...
//
	CLK_LOOKUP("iface_clk",		gsbi6_p_clk.c,  "msm_serial_hs.0"),
	CLK_LOOKUP("iface_clk",		gsbi7_p_clk.c,		"qup_i2c.7"),   /* Modified By jzq for Flash 12.11.06*/
	...
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0020"),
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0034"),
#if defined (CONFIG_MACH_MAZAMA)|| defined (CONFIG_MACH_QUANTUM)
    	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"4-0036"),//add by lijing for p896d01
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0010"),//add by lijing for ov9740
#else
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0036"),//add by wxl for p896a25
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0010"), //add by lijing for P896F10 20121114  
#endif
	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"7-001f"),//add by wt
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-003c"),// added for ov5640 ZTE_CAM_CDZ
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-001e"),// added for ov7692 ZTE_CAM_CDZ
	CLK_LOOKUP("csi_src_clk",	csi0_src_clk.c,		"msm_csid.0"),
	CLK_LOOKUP("csi_src_clk",	csi1_src_clk.c,		"msm_csid.1"),
	CLK_LOOKUP("csi_src_clk",	csi2_src_clk.c,		"msm_csid.2"),
	CLK_LOOKUP("csi_clk",		csi0_clk.c,		"msm_csid.0"),
