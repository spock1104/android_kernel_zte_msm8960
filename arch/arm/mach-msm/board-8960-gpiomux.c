...
#if defined(CONFIG_MACH_OKMOK) || defined (CONFIG_MACH_ROUNDTOP) || defined(CONFIG_MACH_MAZAMA) || defined(CONFIG_MACH_NUNIVAK)|| defined(CONFIG_MACH_QUANTUM)|| defined(CONFIG_MACH_PRINDLE)|| defined(CONFIG_FLSH_ADP1650)
...
#if 1
static struct gpiomux_setting in_pn_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.dir = GPIOMUX_IN,
	.pull = GPIOMUX_PULL_NONE,
...
#if 1
	{	/* Headset Detection */
	//zte_audio_gushenggao_20130322 pull up change to pull none
		.gpio = 50,
		.settings = {
			[GPIOMUX_ACTIVE]    = &in_pn_cfg,
			[GPIOMUX_SUSPENDED] = &in_pn_cfg,
		},
	},
#endif
...
//add by wxl for p896a25 
#if defined(CONFIG_MACH_OKMOK) || defined (CONFIG_MACH_ROUNDTOP) || defined(CONFIG_MACH_MAZAMA)||  defined (CONFIG_MACH_NUNIVAK)|| defined(CONFIG_MACH_QUANTUM) || defined(CONFIG_MACH_PRINDLE)
	{
		.gpio      = 9,		/* camera dvdd */
		.settings = {
