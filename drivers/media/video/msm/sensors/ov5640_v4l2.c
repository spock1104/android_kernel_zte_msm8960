...
int current_saturation_value=2;
int current_contrast_value=0;
int current_sharpness_value=0;
int ov5640_preview_set_saturation(struct msm_sensor_ctrl_t *s_ctrl, int value);
int current_brightness_value=0;
uint16_t ov5640_autoflashflag;
static int8_t  zte_effect=0;

static bool   is_caf_started=0;
...
int focusmode_state=0;
/*
focusmode_state=0,  normal  
focusmode_state=1,  macro 
focusmode_state=2,  auto
focusmode_state=3,  caf
focusmode_state=4,   infinity 
*/
...
{0x5300, 0x08},
{0x5301, 0x10},
{0x5302, 0x1a},//0x30 modify by lijing 
{0x5303, 0x00},
{0x5309, 0x08},
{0x530a, 0x10},
{0x530b, 0x04},
		...
		struct msm_sensor_v4l2_ctrl_info_t *ctrl_info, int value)
{
	...
	if( current_preview_gain_flash >= 0xF0){
		ov5640_autoflashflag=1;
		
	}else{
	  	ov5640_autoflashflag=0;
	}
	pr_err("%s: set ov5640_autoflashflag to %d \n", __func__,ov5640_autoflashflag);
	return 0;
...
{
        int rc=0;
	uint16_t af_ack=0,i=0;
	 uint16_t caf_r1,caf_r2;
	 pr_err("%s:focusmode_state =%d is_caf_started=%d \n", __func__,focusmode_state,is_caf_started);
	if(focusmode_state!=3||is_caf_started==1){
	return 0;
	}
...
{   
	  ...
	  int i = 0;
	  uint16_t af_ack;
	//pr_err(" %s new focusmode:%d old focusmode_state:%d",__func__,value,focusmode_state);  
	  if(value==focusmode_state){
		return 0;
	  }
	 focusmode_state= value;
	...
	case 1:
		...
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3027, 0x00,
			MSM_CAMERA_I2C_BYTE_DATA);
		if (rc < 0) {
		pr_err("%s: i2c write failed\n", __func__);
		}
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3028, 0xff,
			MSM_CAMERA_I2C_BYTE_DATA);
		if (rc < 0) {
		pr_err("%s: i2c write failed\n", __func__);
		}
		...
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3022, 0x1a,
			MSM_CAMERA_I2C_BYTE_DATA);
		if (rc < 0) {
		pr_err("%s: i2c write failed\n", __func__);
		}
		...
		struct msm_sensor_v4l2_ctrl_info_t *ctrl_info, int value)
{
	...
	pr_err("cdz   %s   value:  %d  current_brightness_value=%d \n", __func__,value,current_brightness_value);
	if(value==current_brightness_value){
	return 0;
	}
	
	current_brightness_value = value;
	switch (value)
	{
		...
		struct msm_sensor_v4l2_ctrl_info_t *ctrl_info, int value)
{
	...
	int16_t  tmp_reg = 0;
	//value=value-3;
	pr_err("cdz   %s   value:  %d  current_contrast_value=%d \n", __func__,value,current_contrast_value);
	if(value==current_contrast_value){
	return 0;
	}
	...
	case CAMERA_CONTRAST_LV0:
		 pr_err("%s   CAMERA_CONTRAST_LV0 \n",__func__);
        {
			...
			return rc;
		      ...
		      rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5586, 0x10,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
			...
			rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5585, 0x10,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
	...
	case CAMERA_CONTRAST_LV1:
		 pr_err("%s   CAMERA_CONTRAST_LV1 \n",__func__);
        {
			...
			return rc;
		      ...
		      rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5586, 0x18,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
			  ...
			  rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5585, 0x18,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
	...
	case CAMERA_CONTRAST_LV2:
		 pr_err("%s   CAMERA_CONTRAST_LV2 \n",__func__);
        {
			...
			return rc;
		      ...
		      rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5586, 0x20,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
			  ...
			  rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5585, 0x00,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
	...
	case CAMERA_CONTRAST_LV3:
		 pr_err("%s   CAMERA_CONTRAST_LV3 \n",__func__);
        {
			...
			return rc;
		      ...
		      rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5586, 0x24,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
	...
	case CAMERA_CONTRAST_LV4:
		 pr_err("%s   CAMERA_CONTRAST_LV4 \n",__func__);
        {
			...
			return rc;
		      ...
		      rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5586, 0x2c,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
			  ...
			  rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5585, 0x1c,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
	...
	default:
		pr_err("%s  contrast value is not supported \n",__func__);
		break;
	}
...
int ov5640_preview_set_saturation(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	...
	pr_err("cdz   %s   value:  %d  current_saturation_value=%d \n", __func__,value,current_saturation_value);
	
	switch (value)
	{
	case MSM_V4L2_SATURATION_L0: 
                 pr_err("%s   MSM_V4L2_SATURATION_L0 \n",__func__); 
        { 
                    tmp_reg = 0; 
                        rc = msm_camera_i2c_read( 
                        s_ctrl->sensor_i2c_client, 
                    ...
                    tmp_reg |= 0x0080; 
                      ...
                      return rc; 
                         ...
                         rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5583, 0x00, 
                      MSM_CAMERA_I2C_BYTE_DATA); 
                      if (rc < 0) { 
                      pr_err("%s: i2c write failed\n", __func__); 
                      return rc; 
                      } 
                        rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5584, 0x00, 
                      MSM_CAMERA_I2C_BYTE_DATA); 
                      if (rc < 0) { 
                      pr_err("%s: i2c write failed\n", __func__); 
                      return rc; 
	...
	case MSM_V4L2_SATURATION_L1:
		 pr_err("%s   MSM_V4L2_SATURATION_L1 \n",__func__);
        {
                    tmp_reg = 0;
			rc = msm_camera_i2c_read(
			s_ctrl->sensor_i2c_client,
			...
			return rc;
			 ...
			 rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5583, 0x20,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
		      }
			rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5584, 0x10,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
	...
	case MSM_V4L2_SATURATION_L2:
		 pr_err("%s   MSM_V4L2_SATURATION_L2 \n",__func__);
        
		{
			...
			return rc;
			 ...
			 rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5583, 0x40,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
		      }
			rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5584, 0x1e,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
	...
	case MSM_V4L2_SATURATION_L3:
		 pr_err("%s   MSM_V4L2_SATURATION_L3 \n",__func__);
        {
                    tmp_reg = 0;
			rc = msm_camera_i2c_read(
			s_ctrl->sensor_i2c_client,
			...
			return rc;
			 ...
			 rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5583, 0x50,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
		      }
			rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5584, 0x38,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
	...
	case MSM_V4L2_SATURATION_L4:
		 pr_err("%s   MSM_V4L2_SATURATION_L4 \n",__func__);
        {
                    tmp_reg = 0;
			rc = msm_camera_i2c_read(
			s_ctrl->sensor_i2c_client,
			...
			return rc;
			 ...
			 rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5583, 0x60,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
		      }
			rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5584, 0x48,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
	...
	default:
		pr_err("%s  saturation value is not supported \n",__func__);
		break;
	}
		...
		struct msm_sensor_v4l2_ctrl_info_t *ctrl_info, int value)
{
	...
	//value=value-3;
	pr_err("cdz   %s   value:  %d  current_saturation_value=%d \n", __func__,value,current_saturation_value);
	if(value==current_saturation_value){
	return 0;
	}
	
	current_saturation_value = value;
		...
		struct msm_sensor_v4l2_ctrl_info_t *ctrl_info, int value)
{
	...
	pr_err("cdz   %s   value:  %d  current_sharpness_value=%d \n", __func__,value,current_sharpness_value);
	if(value==current_sharpness_value){
	return 0;
	}
	
	current_sharpness_value = value;
	switch (value)
	{
	case MSM_V4L2_SHARPNESS_L0:
		 pr_err("%s   MSM_V4L2_SHARPNESS_L0 \n",__func__);
      
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5308 ,0x65,
		MSM_CAMERA_I2C_BYTE_DATA);
		if (rc < 0) {
		pr_err("%s: i2c write failed\n", __func__);
		return rc;
		}
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5302 ,0x00,
		MSM_CAMERA_I2C_BYTE_DATA);
		if (rc < 0) {
		pr_err("%s: i2c write failed\n", __func__);
		return rc;
		}
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5303 ,0x00,
		MSM_CAMERA_I2C_BYTE_DATA);
		if (rc < 0) {
		pr_err("%s: i2c write failed\n", __func__);
		return rc;
	...
	case MSM_V4L2_SHARPNESS_L1:
		 pr_err("%s   MSM_V4L2_SHARPNESS_L1 \n",__func__);
 		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5308 ,0x65,
		MSM_CAMERA_I2C_BYTE_DATA);
		if (rc < 0) {
		pr_err("%s: i2c write failed\n", __func__);
		...
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5302 ,0x10,
		MSM_CAMERA_I2C_BYTE_DATA);
		if (rc < 0) {
		pr_err("%s: i2c write failed\n", __func__);
		return rc;
	...
	case MSM_V4L2_SHARPNESS_L2:
		 pr_err("%s   MSM_V4L2_SHARPNESS_L2 \n",__func__);
      		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5308 ,0x65,
		MSM_CAMERA_I2C_BYTE_DATA);
		if (rc < 0) {
		pr_err("%s: i2c write failed\n", __func__);
		...
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5302 ,0x20,
		MSM_CAMERA_I2C_BYTE_DATA);
		if (rc < 0) {
		pr_err("%s: i2c write failed\n", __func__);
		return rc;
	...
	case MSM_V4L2_SHARPNESS_L3:
		...
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5302 ,0x30,
		MSM_CAMERA_I2C_BYTE_DATA);
		if (rc < 0) {
		pr_err("%s: i2c write failed\n", __func__);
		return rc;
	...
	case MSM_V4L2_SHARPNESS_L4:
		 pr_err("%s   MSM_V4L2_SHARPNESS_L4 \n",__func__);
         		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5308 ,0x65,
		MSM_CAMERA_I2C_BYTE_DATA);
		if (rc < 0) {
		pr_err("%s: i2c write failed\n", __func__);
		...
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x5302 ,0x40,
		MSM_CAMERA_I2C_BYTE_DATA);
		if (rc < 0) {
		pr_err("%s: i2c write failed\n", __func__);
		return rc;
	...
	default:
		pr_err("%s  sharpness value is not supported \n",__func__);
		break;
	...
	case CAMERA_ANTIBANDING_60HZ:		
	{
		 ...
		 rc = msm_camera_i2c_read(
			...
			return rc;
		      ...
		      rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3C01, tmp_reg,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
		      }
   			 rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3C00, 0x00,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
		 ...
		 rc = msm_camera_i2c_read(
			...
			return rc;
		      ...
		      return rc;
   			 ...
   			 rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3C00, 0x04,
		      MSM_CAMERA_I2C_BYTE_DATA);
		      if (rc < 0) {
		      pr_err("%s: i2c write failed\n", __func__);
		      return rc;
...
int ov5640_set_scenemode(struct msm_sensor_ctrl_t *s_ctrl,
		struct msm_sensor_v4l2_ctrl_info_t *ctrl_info, int value)
{   
      int rc = 0;
	  
	pr_err(" %s value==%d",__func__,value);

	  switch (value)
	{
	case 6:
			{
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3a00, 0x7c,
			      MSM_CAMERA_I2C_BYTE_DATA);
			      if (rc < 0) {
			      pr_err("%s: i2c write failed\n", __func__);
			      return rc;
			      }       
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3a14, 0x0f,
			      MSM_CAMERA_I2C_BYTE_DATA);
			      if (rc < 0) {
			      pr_err("%s: i2c write failed\n", __func__);
			      return rc;
			      }       
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3a15, 0x60,
			      MSM_CAMERA_I2C_BYTE_DATA);
			      if (rc < 0) {
			      pr_err("%s: i2c write failed\n", __func__);
			      return rc;
			      }       
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3a02, 0x0f,
			      MSM_CAMERA_I2C_BYTE_DATA);
			      if (rc < 0) {
			      pr_err("%s: i2c write failed\n", __func__);
			      return rc;
			      }       
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3a03, 0x60,
			      MSM_CAMERA_I2C_BYTE_DATA);
			      if (rc < 0) {
			      pr_err("%s: i2c write failed\n", __func__);
			      return rc;
		...
		default: 
			{
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3a00, 0x78,
			      MSM_CAMERA_I2C_BYTE_DATA);
			      if (rc < 0) {
			      pr_err("%s: i2c write failed\n", __func__);
			      return rc;
			      }       
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3a14, 0x03,
			      MSM_CAMERA_I2C_BYTE_DATA);
			      if (rc < 0) {
			      pr_err("%s: i2c write failed\n", __func__);
			      return rc;
			      }       
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3a15, 0xd8,
			      MSM_CAMERA_I2C_BYTE_DATA);
			      if (rc < 0) {
			      pr_err("%s: i2c write failed\n", __func__);
			      return rc;
			      }       
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3a02, 0x03,
			      MSM_CAMERA_I2C_BYTE_DATA);
			      if (rc < 0) {
			      pr_err("%s: i2c write failed\n", __func__);
			      return rc;
			      }       
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x3a03, 0xd8,
			      MSM_CAMERA_I2C_BYTE_DATA);
			      if (rc < 0) {
			      pr_err("%s: i2c write failed\n", __func__);
			      return rc;
...
int ov5640_af_trigger(struct msm_sensor_ctrl_t *s_ctrl,
		struct msm_sensor_v4l2_ctrl_info_t *ctrl_info, int value)
{
    int32_t rc;
    int32_t rc_3028;
	...
	},
{
	...
	},
	{
		...
		.max = 1,
		.step = 1,
		.s_v4l2_ctrl = get_preview_exposure_gain,
	},
	{
	...
	},
	{
		...
		.min = CAMERA_ANTIBANDING_OFF,
		.max = CAMERA_ANTIBANDING_AUTO,
		.step = 1,
	...
	
	{
		...
		.max = 18,
		.step = 1,
		.s_v4l2_ctrl = ov5640_set_scenemode,
	},
	{
		...
		.max = 1,
		.step = 1,
		.s_v4l2_ctrl = get_preview_flash_gain_value,
	},
	{
		.ctrl_id = V4L2_CID_SET_AF_TRIGGER,
		.min = 0,
		.max = 1,
		.step = 1,
		.s_v4l2_ctrl = ov5640_af_trigger,
	},
};
			...
			int update_type, int res)
{
	...
	if (update_type == MSM_SENSOR_REG_INIT) {
		...
		ov5640_preview_set_saturation(s_ctrl,current_saturation_value);
		...
		//normal/auto/infinity
		if(focusmode_state==0||focusmode_state==2||focusmode_state==4){	
		...
		else if(focusmode_state==3){
	pr_err("%s:is_caf_started:%d \n", __func__,is_caf_started);
...
int32_t msm_ov5640_sensor_power_down(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	s_ctrl->curr_res = MSM_SENSOR_INVALID_RES;
	is_caf_started=0;
	current_saturation_value=2;
       current_contrast_value=2;
       current_sharpness_value=2;
	focusmode_state=0;
	current_brightness_value=2;
	ov5640_autoflashflag=0;
	zte_effect=0;
	return 0;
}
static enum msm_camera_vreg_name_t ov5640_veg_seq[] = {
	CAM_VANA,
...
static struct msm_sensor_ctrl_t ov5640_s_ctrl = {
	...
	.vreg_seq = ov5640_veg_seq,
	.num_vreg_seq = ARRAY_SIZE(ov5640_veg_seq),
