...
static struct pm8xxx_gpio_init pm8921_gpios[] __initdata = {
	...
	//PM8XXX_GPIO_OUTPUT_VIN1(6, 0, PM_GPIO_VIN_VPH),	
	#endif
...
#if 0
	, PM8XXX_GPIO_OUTPUT_FUNC(44, 0, PM_GPIO_FUNC_1)	//shaohua add for 43341 32k clk 
#endif
//jht 20121222 add for BCM43341 ---
};
...
#ifdef CONFIG_MACH_MAZAMA	
	PM8XXX_MPP_INIT(7, D_INPUT, PM8921_MPP_DIG_LEVEL_VPH, DIN_TO_INT),
#else
        PM8XXX_MPP_INIT(PM8XXX_AMUX_MPP_7, A_INPUT, PM8XXX_MPP_AIN_AMUX_CH9, DOUT_CTRL_LOW), //Disable it  by ZTE_XJB_PM_20121010
        //PM8XXX_MPP_INIT(PM8XXX_AMUX_MPP_7, D_OUTPUT, PM8921_MPP_DIG_LEVEL_S4, DOUT_CTRL_LOW), //add by stone 20120229
#endif
...
#elif defined CONFIG_MACH_NUNIVAK/*P896T10*/ ||defined CONFIG_MACH_ROUNDTOP /*P896A11*/
static const unsigned int keymap[] = {
	KEY(0, 0, KEY_VOLUMEUP),
	KEY(0, 1, KEY_VOLUMEDOWN),
	KEY(1, 0, KEY_CAMERA_FOCUS),
...
//ZTE_XJB_PM_20121020
#if defined(CONFIG_ZTE_BATTERY_QUANTUM_4350MV_2500MAH)||defined(CONFIG_ZTE_BATTERY_MAZAMA_4350MV_2500MAH)||defined(CONFIG_ZTE_BATTERY_ROUNDTOP_4350MV_1780MAH)\
||defined(CONFIG_ZTE_BATTERY_NUNIVAK_4350MV_1780MAH)||defined(CONFIG_ZTE_BATTERY_PRINDLE_4350MV_3200MAH)||defined(CONFIG_ZTE_BATTERY_GORDON_4350MV_1780MAH) \
||defined(CONFIG_ZTE_BATTERY_ELDEN_4350MV_1780MAH)||defined(CONFIG_ZTE_BATTERY_HAYES_4350MV_1780MAH) 
...
static struct pm8921_charger_platform_data pm8921_chg_pdata __devinitdata = {
	...
	.max_bat_chg_current	= 1500,//XJB 
	#else
	.max_bat_chg_current	= 1200,//1100,//zte//test by zhang.yu_1 
	#endif
...
void __init msm8960_init_pmic(void)
{
	...
	if (!machine_is_msm8960_fluid() && !machine_is_msm8960_liquid()
		...
		pm8921_chg_pdata.battery_less_hardware = 0;   //ZTE_XJB_20130201 1-->0;
}
