...
--------     ----       -------------------------------------              ----------------------------------
2012-08-29  zhaobin     Set default value of restart_level RESET_SUBSYS_INDEPENDENT       ZTE_ZB_BOOT_120829_01
===========================================================================*/
...
static int restart_level = RESET_SUBSYS_INDEPENDENT; //ZTE_ZB_BOOT_120829_01
