...
/*
 * Backlight control in FTM mode by ZTE_BOOT_JIA_20120920 jia.jia
 */
#if 0//def CONFIG_ZTE_BOOT_MODE   //pan move to msm_fb.c
        if (1 == socinfo_get_ftm_flag()) 
	{
            rc = gpio_direction_output(gpio_blk, 1);
        } 
...
static struct mipi_dsi_panel_platform_data novatek_pdata = {
	...
	.phy_ctrl_settings =NULL,// &dsi_novatek_cmd_mode_phy_db,
};
...
unsigned char msm8960_mhl_display_enabled(void)
{
