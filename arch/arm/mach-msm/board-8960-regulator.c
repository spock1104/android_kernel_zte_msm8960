...
VREG_CONSUMERS(L11) = {
	...
	REGULATOR_SUPPLY("cam_vana",		"4-0048"), //jzq mt9m114 p896a11
#endif	
	REGULATOR_SUPPLY("cam_vana",		"4-0020"),
	REGULATOR_SUPPLY("cam_vana",		"4-0034"),
#if defined(CONFIG_MACH_QUANTUM) ||defined(CONFIG_MACH_HAYES)  || defined(CONFIG_MACH_GORDON)
	REGULATOR_SUPPLY("cam_vana",		"4-0010"),// Add by lijing for ov9740 20121014
#else
       REGULATOR_SUPPLY("cam_vana",		"4-0010"),// //add by lijing for P896F10 20121114  
	REGULATOR_SUPPLY("cam_vana",		"4-0036"),//add by wxl for p896a25
#endif

#if defined (CONFIG_MACH_ROUNDTOP) || defined (CONFIG_MACH_OKMOK)
       REGULATOR_SUPPLY("cam_vanabug",		"4-0036"),
#endif //jzq add for fix can not probe 8825 bug       

#if defined (CONFIG_MACH_ELDEN) 
	REGULATOR_SUPPLY("cam_vana",		"4-003c"),// Added by ZTE_CAM-CDZ for OV5640
	REGULATOR_SUPPLY("cam_vana",		"4-001e"),// Added by ZTE_CAM-CDZ for OV7692
#elif defined (CONFIG_MACH_HAYES)
//	REGULATOR_SUPPLY("cam_vana",		"4-0010"),// Added by ZTE_CAM-CDZ for OV9740
	REGULATOR_SUPPLY("cam_vana",		"4-003c"),// Added by ZTE_CAM-CDZ for OV5640
#endif
...
VREG_CONSUMERS(L16) = {
	...
	REGULATOR_SUPPLY("cam_vaf",	 	"7-001f"),// Added by ZTE_CAM- ISP
#if defined (CONFIG_MACH_ROUNDTOP) || defined (CONFIG_MACH_OKMOK) ||defined (CONFIG_MACH_MAZAMA)|| defined (CONFIG_MACH_NUNIVAK)	|| defined (CONFIG_MACH_QUANTUM) || defined(CONFIG_MACH_PRINDLE)
	REGULATOR_SUPPLY("cam_vaf",		"4-0036"), //add by wxl for ov8825 p896a25
#endif	
#if defined (CONFIG_MACH_ELDEN) ||defined (CONFIG_MACH_HAYES)
	REGULATOR_SUPPLY("cam_vaf",		"4-003c"),// Added by ZTE_CAM-CDZ for OV5640
#endif
};
VREG_CONSUMERS(L17) = {
...
VREG_CONSUMERS(L29) = {
	...
	REGULATOR_SUPPLY("cam_vio",		"4-0036"),      //add by jzq for p896a11	
#endif	
#if defined (CONFIG_MACH_QUANTUM)
	REGULATOR_SUPPLY("cam_vio_l29",		"4-0036"), 
#endif
};
VREG_CONSUMERS(S1) = {
...
#ifdef CONFIG_MACH_OKMOK	 
	REGULATOR_SUPPLY("cam_vio",		"4-0036"), //add by wxl for p896a25
#endif 	

#if defined (CONFIG_MACH_ROUNDTOP)|| defined (CONFIG_MACH_NUNIVAK)
	REGULATOR_SUPPLY("cam_vio",		"4-0048"), //add by jzq for p896a11
#endif	

#if defined (CONFIG_MACH_ELDEN) 
	REGULATOR_SUPPLY("cam_vdig",	"4-003c"),// Added by ZTE_CAM-CDZ for OV5640
	REGULATOR_SUPPLY("cam_vdig",	"4-001e"),// Added by ZTE_CAM-CDZ for OV7692	
#elif defined (CONFIG_MACH_HAYES)
	REGULATOR_SUPPLY("cam_vio",	"4-003c"),// Added by ZTE_CAM-CDZ for OV5640
	REGULATOR_SUPPLY("cam_vdig",	"4-003c"),// Added by ZTE_CAM-CDZ for OV5640
#endif
...
#if defined (CONFIG_MACH_QUANTUM)
	REGULATOR_SUPPLY("cam_vio_lvs5",		"4-0036"),
#endif
#if defined (CONFIG_MACH_MAZAMA)
       REGULATOR_SUPPLY("cam_vio",		"4-0036"),   //P896D01 new board
#endif
#if defined (CONFIG_MACH_ROUNDTOP)|| defined (CONFIG_MACH_NUNIVAK)	|| defined (CONFIG_MACH_OKMOK)	
       REGULATOR_SUPPLY("cam_vdig",		"4-0048"),    //jzq mt9m114 p896a11   
#endif
#if defined(CONFIG_MACH_PRINDLE)
	REGULATOR_SUPPLY("cam_vdig",		"4-0010"),    //add by lijing for P896F10 20121114  
#endif

#if (!defined (CONFIG_MACH_ROUNDTOP)) && (!defined (CONFIG_MACH_NUNIVAK))	
	REGULATOR_SUPPLY("cam_vio",		"4-0048"),    //jzq mt9m114 p896a11   
#endif	
	REGULATOR_SUPPLY("cam_vio",		"4-0020"),
	REGULATOR_SUPPLY("cam_vio",		"4-0034"),
#if defined (CONFIG_MACH_ROUNDTOP) || defined (CONFIG_MACH_OKMOK)	
       REGULATOR_SUPPLY("cam_vdigbug",	"4-0036"), 
#endif //jzq add for fix can not probe 8825 bug       

#if defined (CONFIG_MACH_ELDEN) 
	REGULATOR_SUPPLY("cam_vio",		"4-003c"),// Added by ZTE_CAM-CDZ for OV5640
	REGULATOR_SUPPLY("cam_vio",		"4-001e"),// Added by ZTE_CAM-CDZ for OV7692
#endif
...
#if defined (CONFIG_MACH_MAZAMA)|| defined (CONFIG_MACH_ROUNDTOP)|| defined (CONFIG_MACH_NUNIVAK)||defined(CONFIG_MACH_QUANTUM)||defined(CONFIG_MACH_GORDON)
