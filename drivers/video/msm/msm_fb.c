...
static int msm_fb_register(struct msm_fb_data_type *mfd)
{
	...
	#if defined( CONFIG_MACH_OKMOK)
	var->height =95,	/* height of picture in mm */
	var->width = 53,	/* width of picture in mm */
	#elif (defined(CONFIG_MACH_QUANTUM)||defined(CONFIG_MACH_MAZAMA))
...
static void bl_workqueue_handler(struct work_struct *work)
{
	...
	if ((pdata) && (pdata->set_backlight) && (!bl_updated)) {
		...
		pdata->set_backlight(mfd);
		bl_level_old =mfd->bl_level;// unset_bl_level;
		bl_updated = 1;
		up(&mfd->sem);
	}
}
			      ...
			      struct fb_info *info)
{
	...
	if ( !bl_updated)//if (unset_bl_level && !bl_updated)
	{
		printk("\n pan_display backlight ctl ");
...
static int msm_fb_lcd_read_proc(char *page, char **start, off_t off, int count, int *eof, void *data)
{
	int len = 0;
       ...
       //printk("msm_fb_lcd_read_proc, LcdPanleID = %d\n", LcdPanleID);
	...
	switch(LcdPanleID)
	{
		...
		case LCD_PANEL_4P0_HX8363_IVO_YUSHUN:
			...
			break;		
		case LCD_PANEL_4P0_NT35510_BOE_BOE:
			strcpy(module_name,"zteBOE_BOE(NT35510)_480*800_4.0Inch");
			break;
		case LCD_PANEL_4P0_HX8363_IVO_CMI:
			strcpy(module_name,"zteCMI_IVO(HX8363)_480*800_4.0Inch");
			break;
		...
		case LCD_PANEL_4P3_OTM1281_OT_TRULY:
			strcpy(module_name,"zteTRULY_AUO(OTM1281)_720*1280_4.3Inch");
			break;
		case LCD_PANEL_4P3_NT35590_TIANMA:
			strcpy(module_name,"zteTIANMA(NT35590)_720*1280_4.3Inch");
			break;
		case LCD_PANEL_4P3_OTM1281_OT_CMI:
			strcpy(module_name,"zteCMI(OTM1283A)_720*1280_4.3Inch");
			break;
		case LCD_PANEL_5P0_HX8394_BOE_BOE:
			strcpy(module_name,"zteBOE(HX8394)_720*1280_5.0Inch");
			break;
		case LCD_PANEL_5P0_NT35590_CMI_CMI:
			strcpy(module_name,"zteCMI(NT35590)_720*1280_5.0Inch");
			break;
		case LCD_PANEL_5P7_OTM1283A_AUO_LEAD:
			strcpy(module_name,"zteLEAD_AUO(OTM1283A)_720*1280_5.7Inch");
			break;
		case LCD_PANEL_5P7_OTM1283A_BOE_BOE:
			strcpy(module_name,"zteBOE(OTM1283A)_720*1280_5.7Inch");
			break;
		case LCD_PANEL_5P7_OTM1283A_CPT:
			strcpy(module_name,"zteCPT(OTM1283A)_720*1280_5.7Inch");
			break;
		case LCD_PANEL_MAX:
