...
/* liulu add this,because P896A25 doesn't have mosfet,external pull-up regulator is L6,however internal is L7 */
#ifdef CONFIG_MMC_MSM_CARD_DECREASE_SlEEP_CURRENT
...
extern int zte_wifi_status_register(
